...
const primaryFeatures = [
    {
        ...
        description: 'Track all your items along with cost, profit, and booths in one friendly environment.',
        icon: ListBulletIcon,
    },
    {
        name: 'Personal breakdown.',
        description: 'Keep an eye on your progress and many items you\'ve been sourcing and selling over time.',
        icon: UserIcon,
    },
    {
        name: 'Customized insights.',
        description: 'Learn what\'s selling best and where, so you can source items you are confident will spark joy.',
...
export default function ConsignerLanding() {
    ...
    return (
        <div className="bg-white">
                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            <span className="sr-only">Eden</span>
                            <img
            ...
            <main>
                {/* Hero section */}
                <div className="relative isolate z-10 pt-16">
                    <svg
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:flex lg:items-center lg:gap-x-10 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                            <h1 className="max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                                Manage your antiques the simple way.
                            </h1>
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                Leave your notes and spreadsheets behind. Use Eden to save time tracking your items and sales,
                                while gaining insights into what your customers love.
                            </p>
                        ...
                        <div className="mt-10 lg:mt-32 lg:flex-shrink-0 lg:flex-grow">
                            <svg viewBox="0 0 366 729" role="img" className="mx-auto max-w-full drop-shadow-xl w-[22.875rem]">
                ...
                {/* Feature section */}
                <div className="mx-auto max-w-7xl -mt-12 lg:mt-20 sm:px-6 lg:px-8" id="features">
                    <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
                        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
                            ...
                            <div className="max-w-xl lg:row-start-3 lg:mt-10 lg:max-w-md lg:border-t lg:border-white/10 lg:pt-10">
                                <dl className="max-w-xl text-base leading-7 text-gray-300 space-y-8 lg:max-w-none">
                ...
                <div className="relative isolate mt-16 sm:mt-20 sm:pt-20" id="testimonials">
                    {/*Background grid*/}
                    <svg
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
                                ...
                                {testimonials.map((columnGroup, columnGroupIdx) => (
                                    <div key={columnGroupIdx} className="space-y-8 xl:space-y-0 xl:contents">
            ...
            {/* Footer */}
            <footer className="mt-6 flex flex-col content-center mt-12" aria-labelledby="footer-heading">
                <h2 id="footer-heading" className="sr-only">
                    Footer
                </h2>
                <div className="w-full flex justify-center gap-6 md:gap-8 md:order-2 md:my-2">
                ...
                <p className="mt-4 text-xs leading-5 text-gray-400 md:order-1 md:mt-0 text-center">
                    &copy; 2024 Eden, Inc. All rights reserved.
                </p>
            </footer>
        </div>
    )
