...
const primaryFeatures = [
  {
    ...
    description:
      "Track all your items along with cost, profit, and booths in one friendly environment.",
    icon: ListBulletIcon,
  },
  {
    name: "Personal breakdown.",
    description:
      "Keep an eye on your progress and many items you've been sourcing and selling over time.",
    icon: UserIcon,
  },
  {
    name: "Customized insights.",
    description:
      "Learn what's selling best and where, so you can source items you are confident will spark joy.",
  ...
  return (
    <div className="bg-white">
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:items-center lg:gap-x-10 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Leave your notes and spreadsheets behind. Use Seed to save time
                tracking your items and sales, while gaining insights into what
                your customers love.
              </p>
            ...
            <div className="mt-10 lg:mt-32 lg:flex-shrink-0 lg:flex-grow">
              <svg
                viewBox="0 0 366 729"
                role="img"
                className="mx-auto max-w-full drop-shadow-xl w-[22.875rem]"
              >
        ...
        {/* Feature section */}
        <div
          className="mx-auto max-w-7xl -mt-12 lg:mt-20 sm:px-6 lg:px-8"
          id="features"
        >
        ...
        <div
          className="relative isolate mt-16 sm:mt-20 sm:pt-20"
          id="testimonials"
        >
          {/*Background grid*/}
          <svg
          ...
          <div className="relative">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-xl sm:text-center">
                <h2 className="text-lg font-semibold leading-8 tracking-tight text-accent/80">
                  Testimonials
                </h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  Antique consigners love using Seed.
                </p>
              </div>
      ...
      {/* Footer */}
      <footer
        className="mt-6 flex flex-col content-center mt-12"
      ...
      >
        ...
        <p className="mt-4 text-xs leading-5 text-gray-400 md:order-1 md:mt-0 text-center">
          &copy; 2024 Seed, Inc. All rights reserved.
        </p>
      </footer>
    </div>
  );
